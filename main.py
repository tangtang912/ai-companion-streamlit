...
from streamlit import subheader, session_state
...
if "nick_name" not in st.session_state:
    st.session_state.nick_name = "大屁"
# 性格
if "nature" not in st.session_state:
    st.session_state.nature = "风趣幽默，博学多才的人。"
# 会话标识
...
# nick_name = st.sidebar.text_input("昵称","大屁")
with st.sidebar:
    #会话信息
    st.subheader("AI控制面板")
...
if prompt: # 字符串会自动转换为布尔值，如果字符串非空，则为True;否则为False。
    ...
    response_message = st.empty() # 创建一个空的组建，用于展示大模型返回的结果
    full_response = ""
